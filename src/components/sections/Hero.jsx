...
function Hero() {
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-16 pt-6">
        <img
          src={logo}
          alt="Tycoon Logo"
          className="w-24 sm:w-28 md:w-32 lg:w-40 mx-auto sm:mx-0"
        />
      </div>

      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between h-full px-4 sm:px-6 md:px-10 lg:px-16">
        <div className="max-w-full lg:max-w-xl text-center lg:text-left">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-snug sm:leading-tight lg:leading-tight">
        ...
        <div className="relative mt-8 lg:mt-0 flex justify-center lg:justify-end">
          <img
            ...
            className="w-[180px] sm:w-[260px] md:w-[320px] lg:w-[420px] drop-shadow-[0_0_20px_rgba(0,180,255,0.35)]"
          />
        </div>
      </div>

      <div className="absolute bottom-6 sm:bottom-10 left-0 w-full overflow-hidden opacity-40">
